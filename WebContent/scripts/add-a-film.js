// This function passes 7 variables.
...
function addNewFilmToJson(resultsRegion, id, title, year, director, stars, review) {
	
// This is used for knowing which servlet it needs to be passed to
	var servletName = "addAFilm"; 
...
// Passes All variables into one single variable = data
...
// Ajax Post sends the data over to the 
